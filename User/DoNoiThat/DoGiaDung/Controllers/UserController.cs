...
namespace DoGiaDung.Controllers
{
    public class UserController : Controller
    {
        ...
        public void SendVerificationLinkEmail(string emailID, string activationCode, string emailFor = "VerifyAccount")
        {
            ...
            var fromEmail = new MailAddress("raovat.huflit@gmail.com", "Prime Home Reset Password");
            ...
            {
                body = "<br/><br/>We are excited to tell you that your PrimeHome account is" +
            ...
            else if (emailFor == "ResetPassword")
            {
                ...
                body = "Chào bạn: " + emailID + "," +
                    "<br><br />Bạn vừa yêu cầu lấy lại mật khẩu tài khoản trên Website primehome.vn" +
